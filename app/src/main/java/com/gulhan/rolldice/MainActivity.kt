...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        photo.setImageResource(R.drawable.ic_dice)
    ...
    fun rollDice(){
        ...
        if (randomNumber == 1){
            photo.setImageResource(R.drawable.ic_dice1)
        }
        if (randomNumber == 2){
            photo.setImageResource(R.drawable.ic_dice2)
        }
        if (randomNumber == 3){
            photo.setImageResource(R.drawable.ic_dice3)
        }
        if (randomNumber == 4){
            photo.setImageResource(R.drawable.ic_dice4)
        }
        if (randomNumber == 5){
            photo.setImageResource(R.drawable.ic_dice5)
        }
        if (randomNumber == 6){
            photo.setImageResource(R.drawable.ic_dice6)
        }

        // YOU CAN EITHER USE "IF" OR "WHEN" CONDITIONS.
      /* when (randomNumber) {
            1 -> photo.setImageResource(R.drawable.ic_dice1)
            2 -> photo.setImageResource(R.drawable.ic_dice2)
            3 -> photo.setImageResource(R.drawable.ic_dice3)
            4 -> photo.setImageResource(R.drawable.ic_dice4)
            5 -> photo.setImageResource(R.drawable.ic_dice5)
            6 -> photo.setImageResource(R.drawable.ic_dice6)
        }*/
